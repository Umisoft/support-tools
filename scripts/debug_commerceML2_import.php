<?php
	/*
	 * Скрипт позволяет отобразить результат преобразования из фомата commerceML2 в umiDump 2.0 по шаблонам используемым в системе
	 * GET параметры:
	...
	// Сплиттер выполняет преобразование формата файла из commerceML2 в umiDump 2.0 по шаблонам
	$splitter = umiImportSplitter::get('commerceML2');
